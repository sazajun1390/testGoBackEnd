...
// HasParticipatisRooms applies the HasEdge predicate on the "participatis_rooms" edge.
func HasParticipatisRooms() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasParticipatisRoomsWith applies the HasEdge predicate on the "participatis_rooms" edge with a given conditions (other predicates).
func HasParticipatisRoomsWith(preds ...predicate.ChatRoom) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newParticipatisRoomsStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
...
func HasMembershipsWith(preds ...predicate.ChatRoomMember) predicate.User {
	return predicate.User(func(s *sql.Selector) {
